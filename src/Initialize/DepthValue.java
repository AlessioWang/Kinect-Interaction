 ...
 * @date 2020/11/22
 **/
public class DepthValue extends PApplet {
    public static void main(String[] args) {
        PApplet.main("Initialize.DepthValue");
    }
...
//        int w = (int) (DEPTH_CAMERA_WIDTH + RGB_CAMERA_WIDTH * 0.5);
//        int h = (int) (DEPTH_CAMERA_WIDTH + RGB_CAMERA_HEIGHT * 0.5);
        int w = (int) (2*DEPTH_CAMERA_WIDTH );
        int h = (int) (2*DEPTH_CAMERA_WIDTH );
        size(w, h);
//        size(DEPTH_CAMERA_WIDTH, DEPTH_CAMERA_HEIGHT);
    }
